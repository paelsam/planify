...
import { saveSubject, getCategories } from '../utils/storage';
...
export function AddSubjectModal({ isOpen, onClose, onSubjectAdded }: AddSubjectModalProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast.success('Materia agregada. Ya puedes planear sesiones para ella.');
    setName('');
    setCategory('');
        ...
        >
          ...
          >
            <div className="flex items-center justify-between p-6 border-b-4 border-black bg-[#FFD93D]">
              <h2 className="text-2xl font-black uppercase">Agregar Materia</h2>
              <button
                onClick={onClose}
            ...
            <form onSubmit={handleSubmit} className="p-6">
              ...
              <div className="mb-6">
                ...
                <p className="mt-2 text-xs font-bold opacity-70">
                  ¿No encuentras la que necesitas? Créala en Categorías.
                </p>
              </div>
              ...
              <button
                type="submit"
                className="w-full bg-black text-white border-4 border-black p-4 font-black text-lg uppercase hover:bg-gray-800 transition-colors"
